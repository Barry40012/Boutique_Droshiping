...
@endphp
<div class="store-public-page classic-template">
...
@keyframes glowBtn { 0%{box-shadow:0 0 10px rgba(14,165,233,0.6);}50%{box-shadow:0 0 20px rgba(14,165,233,0.9);}100%{box-shadow:0 0 10px rgba(14,165,233,0.6);} }
