// Liste complète des pays avec leurs codes ISO et drapeaux (emoji)
const countries = [
...
// Liste des devises avec leurs symboles
const currencies = [
...
// Fonction pour obtenir le taux de change (simulation - à remplacer par une vraie API)
async function getExchangeRate(fromCurrency, toCurrency) {
  // Pour l'instant, on retourne des taux fixes
  // Plus tard, on pourra utiliser une API comme exchangerate-api.com ou fixer.io
  const rates = {
    'USD': { 'GNF': 8600, 'EUR': 0.92, 'XOF': 600 },
    'EUR': { 'GNF': 9300, 'USD': 1.09, 'XOF': 650 },
    'GNF': { 'USD': 0.000116, 'EUR': 0.000107, 'XOF': 0.07 },
    'XOF': { 'GNF': 14.3, 'USD': 0.00167, 'EUR': 0.00154 },
  };
  
  if (rates[fromCurrency] && rates[fromCurrency][toCurrency]) {
    return rates[fromCurrency][toCurrency];
  }
  return 1; // Par défaut, taux de 1:1
}
